    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <div class="modal-content">
        <div id="kt_modal_add_reschedule_header" class="modal-header">
          ...
          <div
            id="kt_modal_add_reschedule_close"
        ...
        <form
          id="kt_modal_add_reschedule_form"
          class="el-form el-form--default el-form--label-right form">
          <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
            <div
              id="kt_modal_add_reschedule_scroll"
              data-kt-scroll="true"
            ...
            <div class="text-center pt-15">
              ...
              <button
                ...
                @click.prevent="handleRescheduleSubmit"
            ...
            <data-table
              ...
              <template #title="{row: conference}">
                <div v-if="conference.ref_type === 1">
                  <a
                    class="text-danger"
                    :href="`${baseUrl}/group-class/${conference.group_class?.slug}`">
                    {{ conference.title }}
                  </a>
                </div>
              ...
              <template
                ...
                <router-link
                  v-show="abilities.addNote"
                  :to="`/dashboard/conferences/${conference.id}/notes`"
                  aria-label="Add Note"
                  class="btn btn-icon btn-light-primary me-2 notestooltip">
                  <span class="svg-icon svg-icon-primary">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                ...
                <router-link
                  v-show="abilities.addReview"
                  :to="`/dashboard/conferences/${conference.id}/reviews`"
                  aria-label="Create Link"
                  class="btn btn-icon btn-light-success me-2 reviewstooltip">
                ...
                <router-link
                  v-show="abilities.addComplaint"
                  :to="`/dashboard/conferences/${conference.id}/complaints`"
                  aria-label="Create Link"
                  class="btn btn-icon btn-light-warning me-2 complaintstooltip">
                ...
                <router-link
                  v-show="abilities.uploadFile"
                  :to="`/dashboard/conferences/${conference.id}/files`"
    ...
    const getConferenceLink = function getConferenceLink(id) {
      ...
      axiosClient.get(`/conferences/create-student-link/${id}`).then((response) => {
        ...
        if (Response.status === "error") {
          ...
          window.open(Response.join_url ? Response.join_url : Response.start_url, "_blank")
