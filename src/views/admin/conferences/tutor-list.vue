      ...
      <div class="card">
        <div class="card-header border-0 pt-6">
          <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
              ...
              <input id="search-tutor-conferences" type="text" name="search-conferences"
                :placeholder="t('global.search-tutor-conferences')" data-kt-item-table-filter="search"
        ...
        <template v-else>
          <div class="card-body py-4">
            <data-table :data="data" :header="header" :checkbox-enabled="true" :page-current="currentPage"
              checkbox-label="id" :items-total="itemsTotal" :items-per-page="itemsPerPage"
        ...
        .then((response) => {
          ...
          try {
            ...
            if (errorResponse.data.status === "false") {
              ...
              Swal.fire(errorResponse.error, "", "false")
