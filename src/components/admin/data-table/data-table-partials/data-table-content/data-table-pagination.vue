...
export default defineComponent({
  ...
  setup(props, {emit}) {
    ...
    const onClickFirstPage = function onClickFirstPage() {
      const queryString = createQueryString(1, props.itemsPerPage, props.queryString)
    ...
    const onClickPage = function onClickPage(page) {
      const queryString = createQueryString(page, props.itemsPerPage, props.queryString)
      getDataTableBodyRows(queryString)
    ...
    const onClickLastPage = function onClickLastPage() {
      const queryString = createQueryString(props.pageTotal, props.itemsPerPage, props.queryString)
      getDataTableBodyRows(queryString)
