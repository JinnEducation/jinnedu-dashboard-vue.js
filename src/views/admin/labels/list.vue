<!-- DONE REVIEWING: NEW -->
<template>
  <toolbar :title="t('global.labels-management')" />
  <add-label-modal
    ref="addLabelModal"
        ...
        <div class="card-header border-0 pt-6">
          <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
              ...
              <label for="search-labels" class="sr-only">{{ t("global.search-labels") }}</label>
              <input
                id="search-labels"
                type="text"
                name="search-labels"
                :placeholder="t('global.search-labels')"
          ...
          <div class="card-toolbar">
            <div data-kt-label-table-toolbar="base" class="d-flex justify-content-end">
              <button type="button" class="btn btn-primary" @click="showAddModal">
                ...
                {{ t("global.add-button") }} {{ t("global.label") }}
              </button>
            </div>
          </div>
        </div>
            ...
            <data-table
              ...
              <template #actions="{row: label}">
                <button
                  ...
                  @click="showUpdateModal(label.id)">
...
export default defineComponent({
  ...
  setup() {
    ...
    const header = ref([
      ...
      {columnName: t("global.file"), columnLabel: "file", sortEnabled: true, columnWidth: 175},
