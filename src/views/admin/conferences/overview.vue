<!-- DONE REVIEWING: NEW -->
<template>
  <toolbar :title="t('global.conference-add-review')" />
  <add-review-modal
    ref="addReviewModal"
  ...
  <div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
      <information-card :id-current="confid" />
      <!--begin::Row-->
                ...
                <div id="kt_schedule_day_4" class="tab-pane fade show">
                  ...
                  <div class="d-flex flex-stack position-relative mt-8">
                    ...
                    <div class="fw-semibold ms-5 text-gray-600">
                      ...
                      <!--begin::User-->
                      <div class="text-gray-400">Lead by <a href="#">Peter Marcus</a></div>
                      <!--end::User-->
                    </div>
                    <!--end::Info-->
            ...
            <div class="card-body p-9 pt-3">
              ...
              <div class="d-flex flex-column mb-9">
                      ...
                      <div class="mb-10">
                        ...
                        <div>
                          <select
                            ...
                            data-dropdown-parent="#kt_menu_648442c5b0687"
                ...
                <div class="d-flex align-items-center mb-5">
                  ...
                  <div class="fw-semibold">
                    <a class="fs-6 fw-bold text-dark text-hover-primary" href="#"
                      >Create FureStibe branding proposal</a
                    >
                      ...
                      <div class="mb-10">
                        ...
                        <div>
                          <select
                            ...
                            data-kt-select2="true"
                            data-placeholder="Select option"
                            data-dropdown-parent="#kt_menu_648442c5b0697"
                            data-allow-clear="true">
                            <option></option>
                            <option value="1">Approved</option>
                            <option value="2">Pending</option>
                      ...
                      <div class="mb-10">
                        ...
                        <div>
                          <select
                            ...
                            data-kt-select2="true"
                            data-placeholder="Select option"
                            data-dropdown-parent="#kt_menu_648442c5b06a5"
                            data-allow-clear="true">
                            <option></option>
                            <option value="1">Approved</option>
                            <option value="2">Pending</option>
                      ...
                      <div class="mb-10">
                        ...
                        <div>
                          <select
                            ...
                            data-kt-select2="true"
                            data-placeholder="Select option"
                            data-dropdown-parent="#kt_menu_648442c5b06b2"
                            data-allow-clear="true">
                            <option></option>
                            <option value="1">Approved</option>
                            <option value="2">Pending</option>
          ...
          <div class="card card-flush h-lg-100">
            ...
            <div class="card-body d-flex flex-column mb-9 p-9 pt-3">
              ...
              <div class="d-flex align-items-center position-relative mb-7">
                ...
                <!--begin::Details-->
                <div class="fw-semibold">
                  <a href="#" class="fs-6 fw-bold text-gray-900 text-hover-primary"
                    ...
                    <div class="mb-10">
                      ...
                      <div>
                        <select
                          ...
                          data-kt-select2="true"
                          data-placeholder="Select option"
                          data-dropdown-parent="#kt_menu_648442c5b070a"
                          data-allow-clear="true">
                          <option></option>
                          <option value="1">Approved</option>
                          <option value="2">Pending</option>
                    ...
                    <div class="mb-10">
                      ...
                      <div>
                        <select
                          ...
                          data-kt-select2="true"
                          data-placeholder="Select option"
                          data-dropdown-parent="#kt_menu_648442c5b0717"
                          data-allow-clear="true">
                          <option></option>
                          <option value="1">Approved</option>
                          <option value="2">Pending</option>
                    ...
                    <div class="mb-10">
                      ...
                      <div>
                        <select
                          ...
                          data-kt-select2="true"
                          data-placeholder="Select option"
                          data-dropdown-parent="#kt_menu_648442c5b0724"
                          data-allow-clear="true">
                          <option></option>
                          <option value="1">Approved</option>
                          <option value="2">Pending</option>
                    ...
                    <div class="mb-10">
                      ...
                      <div>
                        <select
                          ...
                          data-kt-select2="true"
                          data-placeholder="Select option"
                          data-dropdown-parent="#kt_menu_648442c5b0730"
                          data-allow-clear="true">
                          <option></option>
                          <option value="1">Approved</option>
                          <option value="2">Pending</option>
                    ...
                    <div class="mb-10">
                      ...
                      <div>
                        <select
                          ...
                          data-kt-select2="true"
                          data-placeholder="Select option"
                          data-dropdown-parent="#kt_menu_648442c5b073d"
                          data-allow-clear="true">
                          <option></option>
                          <option value="1">Approved</option>
                          <option value="2">Pending</option>
...
import AddReviewModal from "@/components/admin/modals/forms/add-review-modal.vue"
...
export default defineComponent({
  name: "overview",
  components: {Toolbar, AddReviewModal, DataTable, InformationCard},
  setup() {
    const route = useRoute()
    const {t} = useI18n()
    const confid = ref(route.params.confid)
    const loading = ref(false)
    const header = ref([
      {
        columnName: t("global.file_name"),
        columnLabel: "name",
        sortEnabled: true,
        columnWidth: 175
      },
    ...
    const getDataTableBodyRows = function getDataTableBodyRows(queryString = "") {
      loading.value = true
      axiosClient
        .get(`/conferences/my-reviews/${confid.value}${queryString}`)
        .then((response) => {
    ...
    const deleteReview = function deleteReview(id) {
      Swal.fire({
        icon: "error",
        ...
        if (result.isConfirmed) {
          axiosClient.delete(`/conferences/add-review/delete/${id}`).then(() => {
    ...
    const deleteFewReviews = function deleteFewReviews() {
    ...
    const showAddModal = function showAddModal() {
      idCurrent.value = confid.value
      conferenceCurrent.value = {id: confid.value}
      showModal(addReviewModal.value.addReviewModal.modal)
    }

    const showUpdateModal = function showUpdateModal(id) {
      idCurrent.value = confid.value
      axiosClient.get(`/conferences/add-review/${confid.value}/show/${id}`).then((response) => {
    ...
    var KTProjectOverview = (function () {
      ...
      const lightPrimary = KTUtil.getCssVariableValue("--bs-primary-light")
      const success = KTUtil.getCssVariableValue("--bs-success")
      const lightSuccess = KTUtil.getCssVariableValue("--bs-success-light")
      ...
      const initTable = function () {
        const table = document.querySelector("#kt_profile_overview_table")
        ...
        filterOrders.addEventListener("change", (e) => {
        ...
        $.fn.dataTable.ext.search.push((settings, data, dataIndex) => {
          const min = minDate
          const max = maxDate
          const date = parseFloat(moment(data[1]).format()) || 0 // use data for the age column
        ...
        const filterSearch = document.getElementById("kt_filter_search")
