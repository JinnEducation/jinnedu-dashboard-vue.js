<template>
  <div class="d-flex flex-stack">
    <button ref="button" type="submit" class="btn" style="color: white; background-color: #7e22ce">
    ...
    <!-- <button class="btn border bg-white mb-5" type="button" @click="loginWithGoogle">
      <img alt="google" src="../../../../assets/media/google.png" class="h-30px rounded me-5" />
