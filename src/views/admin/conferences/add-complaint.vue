...
<template>
  <toolbar title="Conference Add Complaint" />
  <add-complaint-modal
                ...
                <div class="d-flex mb-10 p-1">
                  <div class="d-flex flex-column">
                    <div class="d-flex align-items-center mb-2">
                      <router-link
                        :to="`/dashboard/conferences/${conference}/complaints/${complaint.id}`"
...
export default defineComponent({
  ...
  components: {Toolbar, AddComplaintModal, DataTable, InformationCard},
  setup() {
