        ...
        <el-form
          ...
          <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
            <div
              :id="scroll"
              data-kt-scroll="true"
              :data-kt-scroll-wrappers="`#${scroll}`"
              :data-kt-scroll-dependencies="`#${header}`"
            ...
            <div class="text-center pt-15">
              <button type="button" class="btn btn-light me-3" @click="formDiscard">
                {{ t("global.discard") }}
              </button>
              <button
                type="submit"
...
export default defineComponent({
  ...
  setup(props, {emit, expose}) {
    ...
    const formDiscard = function formDiscard() {
      Swal.fire({
        icon: "warning",
        text: t("global.ensure-cancel"),
        showCancelButton: true,
        confirmButtonText: t("global.yes-cancel"),
        ...
        if (result.value) {
          ...
          Swal.fire({
            icon: "warning",
            text: t("global.form-not-canceled"),
    ...
    return {modal, form, loading, formSubmit, formDiscard, t}
  }
})
</script>
