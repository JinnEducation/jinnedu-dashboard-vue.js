        ...
        <div class="card-header border-0 pt-6">
          <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
              ...
              <input id="search-users" type="text" name="search-users" :placeholder="t('global.search-tutors')"
        ...
        <template v-else>
          <div class="card-body py-4">
            <data-table v-if="selectedType === type" :data="data" :header="header" :checkbox-enabled="true"
              ...
              :page-current="currentPage" :items-per-page="itemsPerPage" :query-string="currentSearchQuery"
              @on-sort="onSort" @on-items-select="onItemsSelect">
