<template>
  <modal-layout id="kt_modal_add_constant" ref="addConstantModal" header-id="kt_modal_add_constant_header"
    ...
    <template v-else>
      <div class="fv-row mb-7">
        <label for="constant-name" class="required fw-semibold fs-6 mb-2">
          {{ t("global.name") }}
        </label>
      ...
      <div class="fv-row mb-7">
        <label for="constant-number" class="required fw-semibold fs-6 mb-2">
        ...
        if (valid) {
          ...
          axiosClient[id.value ? "put" : "post"](
              ...
              : `/${constantName.value}/create`,
            {
              ...
              level_number: constant.value.level_number,
