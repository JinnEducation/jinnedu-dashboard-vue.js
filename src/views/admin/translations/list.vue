<!-- DONE REVIEWING: NEW -->
<template>
  <toolbar :title="t('global.translations-management')" />
        ...
        <div class="card-header border-0 pt-6">
          <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
              ...
              <label for="search-translations" class="sr-only">{{
                t("global.search-translations")
              }}</label>
              <input
                id="search-translations"
                type="text"
                name="search-translations"
                :placeholder="t('global.search-translations')"
        ...
        <template v-else>
          <div class="card-body py-4">
            <data-table
              ...
              <template #id="{row: translation}">
                {{ data.indexOf(translation) + 1 }}
              </template>
              ...
              <template #actions="{row: translation}">
                <button
                  ...
                  @click="showUpdateModal(translation.id)">
...
export default defineComponent({
  ...
  setup() {
    ...
    const header = ref([
      ...
      {columnName: t("global.title"), columnLabel: "title", sortEnabled: true, columnWidth: 230},
      {columnName: t("global.label"), columnLabel: "label", sortEnabled: true, columnWidth: 175},
      {
        columnName: t("global.language"),
