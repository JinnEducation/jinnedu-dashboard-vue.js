    ...
    <div class="custom-flex-header">
      ...
      <div class="right-content">
        ...
        <ul class="list-links-with-icons">
          ...
          <!-- <li>
            <button type="button" class="flex items-end" @click="toggleInviteModal">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <button type="button" class="button-white-sign-out" @click="signOut">
          {{ $t("global.sign-out") }}
        </button>
      </div>
    </div>
...
import {defineComponent, ref, onMounted, computed, onBeforeMount, watchEffect} from "vue"
