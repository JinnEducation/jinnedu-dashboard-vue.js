          ...
          <div class="card card-flush">
            <div class="card-body pt-10">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <el-form-item prop="code">
                    <el-input
                      ...
                      type="text"
                      name="discount-code"
                      :placeholder="t('global.enter-code')"
                ...
                <div class="col-12 col-md-6">
                  ...
                  <el-form-item prop="percentage">
                    <el-input-number
                      ...
                      :max="100"
                      :precision="0"
                      :placeholder="t('global.enter-percentage')"
                      style="width: 100%" />
                  </el-form-item>
                </div>
              </div>
                ...
                <div class="col-12 col-md-6">
                  ...
                  <el-form-item prop="starts_at">
                    <el-date-picker
                      ...
                      type="datetime"
                      :placeholder="t('global.select-start-date-time')"
                ...
                <div class="col-12 col-md-6">
                  ...
                  <el-form-item prop="ends_at">
                    <el-date-picker
                      ...
                      type="datetime"
                      :placeholder="t('global.select-end-date-time')"
                      format="YYYY-MM-DD HH:mm:ss"
                      value-format="YYYY-MM-DD HH:mm:ss"
                      style="width: 100%" />
                  </el-form-item>
              ...
              <div class="d-flex justify-content-end">
                <router-link
                  id="cancel"
                  to="/dashboard/discount_codes/index"
